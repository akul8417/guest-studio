...
const Signup = () => {
  ...
  const signupForm = useFormik({
    ...
    onSubmit: (values, { resetForm, setSubmitting }) => {
      ...
      console.log(values);
      axios.post('http://localhost:5000/host/register', values)
        .then((result) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-neutral-900 dark:to-neutral-800">
      <div className="w-full max-w-lg mx-auto bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-lg p-6">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Host Sign Up</h1>
          <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
            Already have an account?
            <Link className="ml-1 text-blue-600 hover:underline dark:text-blue-400" href="../examples/html/signin.html">
              Sign in here
            </Link>
          </p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button className='text-white'
                    type='button'
                    onClick={() => { setPasswordHidden(!passwordHidden) }}> </button>
                  <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                    <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                    </svg>
