...
const updateUser = () => {
  ...
  const submitForm = async (value) => {
    console.log(value);
    const res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/usr/update/${userData._id}`, value);
      ...
      <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-5">
            ...
            {userData !== null ? (<Formik initialValues={userData} onSubmit={submitForm}>{(signupForm) => {
